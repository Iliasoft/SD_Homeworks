...
class MyVeryBestVendingMachineBuilder(VendingMachineBuilder):
    ...
    def load_items(self, myMachine):
        ...
        myMachine.provision(vending_items)
        myMachine.add_inventory(1, mars, 10)
        myMachine.add_inventory(2, mars, 10)
        myMachine.add_inventory(3, snickers, 10)
        myMachine.add_inventory(4, bounty, 10)
        myMachine.add_inventory(5, coke, 10)
        myMachine.add_inventory(6, dietCoke, 10)
        myMachine.add_inventory(7, pythonBook, 10)
    ...
    def load_change(self, myMachine):
        ...
        cashier[PaymentOption(100, False)] = 50
